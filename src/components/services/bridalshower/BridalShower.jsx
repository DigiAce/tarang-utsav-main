      ...
      <section className="relative px-10 md:p-0 transform duration-500 hover:shadow-2xl cursor-pointer hover:-translate-y-1">
        ...
        <div className="content bg-white p-2 pt-8 md:p-12 pb-12 lg:max-w-lg w-full lg:absolute top-48 right-5">
          ...
          <p className="my-3 text-justify font-medium text-gray-700 leading-relaxed">
            Celebrate the bride-to-be with a beautifully curated bridal shower
            filled with love, laughter, and unforgettable memories. From elegant
            decor to personalized themes, we ensure every detail reflects her
            unique style. Let us create a magical experience she’ll treasure
            forever!
          </p>
          <a
